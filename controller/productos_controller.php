<?php
    ...
    class Productos_controller {
        ...
        public function addToCart(){
            ...
            // Debug temporal
            file_put_contents('debug_carrito.log', "=== addToCart DEBUG ===\n", FILE_APPEND);
            file_put_contents('debug_carrito.log', "POST data: " . print_r($_POST, true) . "\n", FILE_APPEND);
            
            // Verificar si está logueado
            if(empty($_SESSION['user'])){
                file_put_contents('debug_carrito.log', "Error: Usuario no logueado\n", FILE_APPEND);
            ...
            if($_SERVER['REQUEST_METHOD'] !== 'POST'){
                file_put_contents('debug_carrito.log', "Error: Método no es POST\n", FILE_APPEND);
            ...
            file_put_contents('debug_carrito.log', "ID Producto: $id_producto, Cantidad: $cantidad\n", FILE_APPEND);

            if($id_producto <= 0 || $cantidad <= 0){
                file_put_contents('debug_carrito.log', "Error: Datos inválidos\n", FILE_APPEND);
            ...
            // Añadir o actualizar cantidad en carrito usando id_producto como clave
            ...
            file_put_contents('debug_carrito.log', "Producto añadido exitosamente al carrito\n", FILE_APPEND);
            file_put_contents('debug_carrito.log', "Carrito actual: " . print_r($_SESSION['carrito'], true) . "\n", FILE_APPEND);
