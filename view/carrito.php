...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset_url('css/style-carrito.css'); ?>">
    <title>Carrito - ArviCuenca</title>
    <!-- Scripts de gestión del carrito -->
    <script src="<?php echo asset_url('js/carrito.js'); ?>"></script>
    <script src="<?php echo asset_url('js/carritoViewer.js'); ?>"></script>
</head>
<body>
    <!-- header -->
    <header>
    ...
    <div class="container">
        ...
        <div class="resumen-pedido">
            <div class="articulo">
                <img src="<?php echo asset_url('recursos/filtros-aceite.png'); ?>" alt="Artículo">
            </div>
            <div class="detalles">
                <div class="fila">
