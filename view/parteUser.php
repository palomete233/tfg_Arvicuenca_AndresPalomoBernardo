...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/style-parteUser.css">
    <title>ArviCuenca</title>
</head>
<body>
    <!-- header -->
    ...
    <main class="cont">
        <section class="desc-section">
            <img src="../recursos/desc.jpg" alt="foto-tienda" class="desc-img">
    ...
    <div class="slider">
        ...
        <div class="slide-track">
            ...
            <div class="slide">
                <img src="../recursos/4.png" alt="">
            </div>
            <div class="slide">
                <img src="../recursos/5.png" alt="">
            </div>
            <div class="slide">
                <img src="../recursos/6.png" alt="">
            </div>
            <div class="slide">
                <img src="../recursos/7.png" alt="">
            </div>
