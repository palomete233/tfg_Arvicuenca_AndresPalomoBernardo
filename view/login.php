...
<body>
    ...
    <div class="form-box">
        ...
        <img src="../recursos/desc.jpg" alt="foto">
        ...
        <form action="index.php?action=deleteCookie" method="post">
            <button class="bt" type="submit">Borrar recordatorio</button>
        </form>

        <a href="index.php?action=registrarse" class="enlace">¿No tienes cuenta?</a>
    </div>
