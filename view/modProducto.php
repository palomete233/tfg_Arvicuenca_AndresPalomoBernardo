...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset_url('css/style-modProductos.css'); ?>">
...
<body>
        ...
        <div class="form-container modprod-form" style="margin-top:12px;">
            <form id="edit-product-form" method="post" action="index.php?action=modProducto" enctype="multipart/form-data">
                ...
                <img id="imagen-preview" alt="Imagen actual del producto" 
                     src="<?php echo asset_url('recursos/no-image.png'); ?>" 
                     style="display: none;">
                <div id="imagen-placeholder" style="display: none; color: #666; font-style: italic; margin-top: 8px;">
    ...
    <script src="<?php echo asset_url('js/modProducto.js'); ?>"></script>
</body>
